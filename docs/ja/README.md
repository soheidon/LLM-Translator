[English](../../README.md) | [日本語](README.md) | [中文(简体)](../zh-CN/README.md) | [中文(繁體)](../zh-TW/README.md) | [한국어](../ko/README.md) | [Français](../fr/README.md) | [Deutsch](../de/README.md) | [Español](../es/README.md)
...
* **多言語UI** — 日本語、英語、中国語（簡体字/繁体字）、韓国語、フランス語、ドイツ語、スペイン語、ポルトガル語、ロシア語、イタリア語に対応します。

### LLM翻訳の特徴

* **多様なLLMプロバイダ対応** — OpenAI, Claude, Gemini, DeepSeek, MiMo, Kimi, Qwen, MiniMAX, Ollama などを利用できます。
* **翻訳プリセット** — ニュース、論文、技術文書、メール、字幕、自然訳、直訳、フォーマル、カジュアル、フレンドリーなど、用途に応じた翻訳スタイルを選べます。
...
* **47言語対応** — 中国語（簡体字/繁体字/香港）やポルトガル語（ブラジル/ポルトガル）を含む47言語から選択可能。言語名は日本語と英語の両方で照合されます。
* **言語自動適用** — 保存したソース言語とターゲット言語を起動時にChatGPTページへ自動的に適用します。
* **言語・コンソールデバッグログ** — 言語選択とコンソール出力の診断ログを内蔵。ステータスバーからコピー可能。設定でON/OFF切替。
